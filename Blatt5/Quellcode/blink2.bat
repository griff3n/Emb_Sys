arm-none-eabi-gcc -mcpu=cortex-m4 -mthumb -O2 -IC:\Users\admin\AppData\Local\Energia15\packages\energia\hardware\tivac\1.0.3\system -std=gnu11 -c -o blink.o blink.c
...
arm-none-eabi-objdump -h -S blink.elf > blink2.asm
pause